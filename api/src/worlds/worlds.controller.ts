...
import { WorldAccessGuard } from '../common/guards/world-access.guard';
...
export class WorldsController {
  ...
  async update(@Param('worldId') id: string, @Body() body: any) {
    ...
    const result = await this.svc.update(id, patch);
  ...
  getLocations(@Param('worldId') wid: string) {
    return this.svc.getLocations(wid);
  }
  ...
  async updateLocation(
    @Param('worldId') wid: string,
    @Param('id') id: string,
    @Body() body: any,
  ) {
    const result = await this.svc.updateLocation(wid, id, body);
    this.gateway.emit('updated', wid, {});
    return result;
  }
  ...
  async removeLocation(@Param('worldId') wid: string, @Param('id') id: string) {
    await this.svc.removeLocation(wid, id);
    this.gateway.emit('updated', wid, {});
  }
  ...
  @Get(':worldId/npcs')
  getNpcs(@Param('worldId') wid: string) {
    return this.svc.getNpcs(wid);
  }
  ...
  async updateNpc(
    ...
    const result = await this.svc.updateNpc(wid, id, body);
    this.gateway.emit('updated', wid, {});
    return result;
  }
  ...
  async removeNpc(@Param('worldId') wid: string, @Param('id') id: string) {
    await this.svc.removeNpc(wid, id);
    this.gateway.emit('updated', wid, {});
  }
  ...
  @Get(':worldId/lore')
  getLore(@Param('worldId') wid: string) {
    return this.svc.getLore(wid);
  }
  ...
  async updateLore(
    ...
    const result = await this.svc.updateLore(wid, id, body);
    this.gateway.emit('updated', wid, {});
    return result;
  }
  ...
  async removeLore(@Param('worldId') wid: string, @Param('id') id: string) {
    await this.svc.removeLore(wid, id);
    this.gateway.emit('updated', wid, {});
  }
  ...
  @Get(':worldId/sectors')
  getSectors(@Param('worldId') wid: string) {
    return this.svc.getSectors(wid);
  }
  ...
  async updateSector(
    ...
    const result = await this.svc.updateSector(wid, id, body);
    this.gateway.emit('updated', wid, {});
    return result;
  }
  ...
  async removeSector(@Param('worldId') wid: string, @Param('id') id: string) {
    await this.svc.removeSector(wid, id);
    this.gateway.emit('updated', wid, {});
  }
  ...
  @UseGuards(WorldAccessGuard)
  async upsertSectorNotes(
    @Param('worldId') wid: string,
    @Param('sectorId') sid: string,
    @Body() body: any,
  ) {
    const result = await this.svc.upsertSectorNotes(
      sid,
  ...
  getSectorLocations(@Param('sectorId') sid: string) {
    return this.svc.getSectorLocations(sid);
  }

  @Post(':worldId/sectors/:sectorId/locations')
  @UseGuards(WorldAccessGuard)
  async createSectorLocation(
    @Param('worldId') wid: string,
    @Param('sectorId') sid: string,
    @Body() body: any,
  ) {
  ...
  @UseGuards(WorldAccessGuard)
  async updateSectorLocation(
    @Param('worldId') wid: string,
    @Param('locationId') lid: string,
    @Body() body: any,
  ) {
  ...
  getLocationPrivateNotes(@Param('locationId') lid: string) {
    return this.svc.getLocationPrivateNotes(lid);
  }
  ...
  getLocationPublicNotes(@Param('locationId') lid: string) {
    return this.svc.getLocationPublicNotes(lid);
  }

  @Patch(':worldId/locations/:locationId/notes')
  @UseGuards(WorldAccessGuard)
  async upsertLocationPublicNotes(
    @Param('worldId') wid: string,
    @Param('locationId') lid: string,
    @Body() body: any,
  ) {
    const result = await this.svc.upsertLocationPublicNotes(
      lid,
      Buffer.from(body.content),
    );
    this.gateway.emit('updated', wid, {});
  ...
  getNpcPrivateNotes(@Param('npcId') nid: string) {
    return this.svc.getNpcPrivateNotes(nid);
  }

  @Patch(':worldId/npcs/:npcId/private-notes')
  @UseGuards(WorldAccessGuard)
  async upsertNpcPrivateNotes(
    @Param('worldId') wid: string,
    @Param('npcId') nid: string,
    @Body() body: any,
  ) {
  ...
  getNpcPublicNotes(@Param('npcId') nid: string) {
    return this.svc.getNpcPublicNotes(nid);
  }

  @Patch(':worldId/npcs/:npcId/notes')
  @UseGuards(WorldAccessGuard)
  async upsertNpcPublicNotes(
    @Param('worldId') wid: string,
    @Param('npcId') nid: string,
    @Body() body: any,
  ) {
    const result = await this.svc.upsertNpcPublicNotes(
      nid,
      Buffer.from(body.content),
    );
    this.gateway.emit('updated', wid, {});
  ...
  getLorePrivateNotes(@Param('loreId') lid: string) {
    return this.svc.getLorePrivateNotes(lid);
  }

  @Patch(':worldId/lore/:loreId/private-notes')
  @UseGuards(WorldAccessGuard)
  async upsertLorePrivateNotes(
    @Param('worldId') wid: string,
    @Param('loreId') lid: string,
    @Body() body: any,
  ) {
  ...
  getLorePublicNotes(@Param('loreId') lid: string) {
    return this.svc.getLorePublicNotes(lid);
  }

  @Patch(':worldId/lore/:loreId/notes')
  @UseGuards(WorldAccessGuard)
  async upsertLorePublicNotes(
    @Param('worldId') wid: string,
    @Param('loreId') lid: string,
    @Body() body: any,
  ) {
    const result = await this.svc.upsertLorePublicNotes(
      lid,
      Buffer.from(body.content),
    );
    this.gateway.emit('updated', wid, {});
  ...
  getAiSettings(@Param('worldId') wid: string) {
    return this.svc.getWorldAiSettings(wid);
  }
