...
export const gameSystemEnum = pgEnum('game_system', [
  'ironsworn',
  'starforged',
]);
...
export const campaignGms = pgTable(
  'campaign_gms',
  {
    campaignId: uuid('campaign_id')
      .notNull()
...
export const worldOwners = pgTable(
  'world_owners',
  {
...
export const worldGuides = pgTable(
  'world_guides',
  {
    worldId: uuid('world_id')
      .notNull()
...
export const worldLocationPrivateNotes = pgTable(
  'world_location_private_notes',
  {
...
export const worldSectorLocations = pgTable('world_sector_locations', {
  ...
  sectorId: uuid('sector_id')
    .notNull()
    .references(() => worldSectors.id, { onDelete: 'cascade' }),
  dataJson: jsonb('data_json').notNull().default({}),
});
...
export const worldLorePrivateNotes = pgTable('world_lore_private_notes', {
  loreId: uuid('lore_id')
    .primaryKey()
    .references(() => worldLore.id, { onDelete: 'cascade' }),
  dataJson: jsonb('data_json').notNull().default({}),
});
...
export const userEntitySettings = pgTable(
